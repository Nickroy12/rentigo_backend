...
async function main() {
    try {
        ...
        const carCollection = db.collection('rentCar');
        ...
        app.get('/api/car', async (req, res) => {
            try {
                ...
                const limitNumber = parseInt(req.query.limit) || 8;
        ...
        app.patch('/api/car/:id', async (req, res) => {
            const id = req.params.id;
        ...
        app.patch('/api/rent/:id', async (req, res) => {
            const id = req.params.id;
